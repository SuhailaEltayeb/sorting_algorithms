...
/**
 * quick_sort - fucntion to perform quich sorting, using lomuto_sort predefined algorithm
...
/**
 * lomuto_sorting - functio to perform quick sorting on list of integers using Lomunto partitioning
 * @array: Array of integers to be sorted
 * @size: array size
